...
namespace TMPro
{
    ...
    public class TMP_SubMeshUI_Effect : MaskableGraphic
    {
        /// <summary>
        ...
        public override Texture mainTexture
        {
            get
            {
                if (this.sharedMaterial != null)
                    return this.sharedMaterial.GetTexture(ShaderUtilities_Effect.ID_MainTex);
        ...
        /// </summary>
        public TextMeshProUGUI_Effect textComponent
        {
            get
            {
                if (m_TextComponent == null)
                    m_TextComponent = GetComponentInParent<TextMeshProUGUI_Effect>();

                return m_TextComponent;
            }
        }
        [SerializeField]
        private TextMeshProUGUI_Effect m_TextComponent;
        ...
        /// <returns></returns>
        public static TMP_SubMeshUI_Effect AddSubTextObject(TextMeshProUGUI_Effect textComponent, MaterialReference materialReference)
        {
            ...
            TMP_SubMeshUI_Effect subMesh = go.AddComponent<TMP_SubMeshUI_Effect>();
        ...
        void ON_MATERIAL_PROPERTY_CHANGED(bool isChanged, Material mat)
        {
            ...
            bool hasCullModeProperty = m_sharedMaterial.HasProperty(ShaderUtilities_Effect.ShaderTag_CullMode);
            float cullMode = 0;

            if (hasCullModeProperty)
            {
                cullMode = textComponent.fontSharedMaterial.GetFloat(ShaderUtilities_Effect.ShaderTag_CullMode);
                m_sharedMaterial.SetFloat(ShaderUtilities_Effect.ShaderTag_CullMode, cullMode);
            }
            ...
            if (m_fallbackMaterial != null && fallbackSourceMaterialID == targetMaterialID && TMP_Settings.matchMaterialPreset)
            {
                ...
                m_fallbackMaterial.SetFloat(ShaderUtilities_Effect.ShaderTag_CullMode, cullMode);
            }
            ...
            if (m_MaskMaterial != null)
            {
                ...
                if (targetMaterialID == sharedMaterialID)
                {
                    ...
                    float stencilID = m_MaskMaterial.GetFloat(ShaderUtilities_Effect.ID_StencilID);
                    float stencilComp = m_MaskMaterial.GetFloat(ShaderUtilities_Effect.ID_StencilComp);
                    m_MaskMaterial.CopyPropertiesFromMaterial(mat);
                    m_MaskMaterial.shaderKeywords = mat.shaderKeywords;

                    m_MaskMaterial.SetFloat(ShaderUtilities_Effect.ID_StencilID, stencilID);
                    m_MaskMaterial.SetFloat(ShaderUtilities_Effect.ID_StencilComp, stencilComp);
                }
                else if (targetMaterialID == maskingMaterialID)
                {
                    ...
                    m_sharedMaterial.SetFloat(ShaderUtilities_Effect.ID_StencilID, 0);
                    m_sharedMaterial.SetFloat(ShaderUtilities_Effect.ID_StencilComp, 8);
                }
                ...
                // Re-sync culling with parent text object
                if (hasCullModeProperty)
                    m_MaskMaterial.SetFloat(ShaderUtilities_Effect.ShaderTag_CullMode, cullMode);
            }
        ...
        {
            float padding = ShaderUtilities_Effect.GetPadding(m_sharedMaterial, m_TextComponent.extraPadding, m_TextComponent.isUsingBold, m_TextComponent);
        ...
        {
            float padding = ShaderUtilities_Effect.GetPadding(mat, m_TextComponent.extraPadding, m_TextComponent.isUsingBold, m_TextComponent);
        ...
        public void UpdateMeshPadding(bool isExtraPadding, bool isUsingBold, TextMeshProUGUI_Effect text)
        {
            m_padding = ShaderUtilities_Effect.GetPadding(m_sharedMaterial, isExtraPadding, isUsingBold, text);
        }
        ...
        protected override void UpdateMaterial()
        {
            ...
            if (m_sharedMaterial.HasProperty(ShaderUtilities_Effect.ShaderTag_CullMode))
            {
                float cullMode = textComponent.fontSharedMaterial.GetFloat(ShaderUtilities_Effect.ShaderTag_CullMode);
                m_sharedMaterial.SetFloat(ShaderUtilities_Effect.ShaderTag_CullMode, cullMode);
            }
        ...
        Material GetMaterial()
        {
            ...
            //    m_padding = ShaderUtilities_Effect.GetPadding(m_sharedMaterial, m_TextMeshPro.extraPadding, false);
