...
namespace TMPro
{
    ...
    public partial class TextMeshProUGUI_Effect
    {
        [SerializeField]
        private bool m_hasFontAssetChanged = false; // Used to track when font properties have changed.

        protected TMP_SubMeshUI_Effect[] m_subTextObjects = new TMP_SubMeshUI_Effect[8];
        ...
        protected override void Awake()
        {
            ...
            TMP_SubMeshUI_Effect[] subTextObjects = GetComponentsInChildren<TMP_SubMeshUI_Effect>();
        ...
        {
            ShaderUtilities_Effect.GetShaderPropertyIDs();

            if (m_sharedMaterial == null) return 0;

            m_padding = ShaderUtilities_Effect.GetPadding(m_sharedMaterial, m_enableExtraPadding, m_isUsingBold, this);
            m_isMaskingEnabled = ShaderUtilities_Effect.IsMaskingEnabled(m_sharedMaterial);
            m_isSDFShader = m_sharedMaterial.HasProperty(ShaderUtilities_Effect.ID_WeightNormal);
            ...
            */
            ...
            for (int i = 0; i < materialCount; i++)
            {
                ...
                if (i > 0)
                {
                    ...
                    {
                        m_subTextObjects[i] = TMP_SubMeshUI_Effect.AddSubTextObject(this, m_materialReferences[i]);
