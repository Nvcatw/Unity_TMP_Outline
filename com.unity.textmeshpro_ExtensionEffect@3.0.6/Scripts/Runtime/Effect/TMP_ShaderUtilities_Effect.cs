...
namespace TMPro
{
    public static class ShaderUtilities_Effect
    {
        // Shader Property IDs
        ...
        public static void UpdateShaderRatios(Material mat, TMP_Text_Effect text)
        {
        ...
        public static float GetPadding(Material material, bool enableExtraPadding, bool isBold, TMP_Text_Effect text)
        {
        ...
        // Function to determine how much extra padding is required as a result of material properties like dilate, outline thickness, softness, glow, etc...
        public static float GetPadding(Material[] materials, bool enableExtraPadding, bool isBold, TMP_Text_Effect text = null)
        {
            //Debug.Log("GetPadding() called.");
            ...
            {
                // Update Shader Ratios prior to computing padding
                UpdateShaderRatios(materials[i], text);
